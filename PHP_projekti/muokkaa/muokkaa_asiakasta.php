        ...
        <div class="row justify-content-center h-100">
            <div class="card w-25 my-auto">
                ...
                <div class='card-body text-center'>
                    ...
                    if(isset($_GET['choose']) && $_GET['choose'] == 'false'){
                        echo    "<div class='alert text-nowrap alert-danger w-100 mx-auto row justify-content-center alert-dismissible center-block show role='alert'>Valitse asiakas
                                    <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
                                                <span aria-hidden='true'>&times;</span></button>
                                    </div>";
                    }
